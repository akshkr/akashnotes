# Day 39: Cost Engineering for LLMs
...
**Next up:** Day 40 - Capstone: RAG Chatbot, where you will build and deploy a complete RAG system with cost tracking built in from the start.
